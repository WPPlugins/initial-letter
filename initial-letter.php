...
Plugin URI: http://www.grimmdude.com/initial-letter-wordpress-plugin/
...
/*  Copyright 2016  Garrett Grimm  (email : garrett@grimmdude.com)
...
if ( ! class_exists('InitialLetter')) {
	class InitialLetter
	{
		...
		{
			if (wp_verify_nonce($_POST['initial_letter_nonce'], 'initial_letter_nonce')) {
